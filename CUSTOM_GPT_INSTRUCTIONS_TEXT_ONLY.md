# Custom GPT Instructions - Text-Only Version (BACKUP)

**Version:** Text-Only (No iframe integration)  
**Status:** ✅ Stable, tested, working  
**Use When:** If iframe integration has issues, fall back to this version
...
## Character Limit: ~3,200 characters (fits in Custom GPT limit)
